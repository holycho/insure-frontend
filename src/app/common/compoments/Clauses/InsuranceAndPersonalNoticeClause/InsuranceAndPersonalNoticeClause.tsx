...
const InsuranceAndPersonalNoticeClause: React.FC = () => {
  useEffect(() => {
    commonService.convertChineseLi('#InsuranceAndPersonalNoticeClause');
  }, []);

  return (
    <div id="InsuranceAndPersonalNoticeClause" className="article-paragraph-00">
      <div className="article-paragraph-00__text article-paragraph-00__text--single">
        蓮花保險股份有限公司(以下稱本公司)依據個人資料保護法（以下稱個資法）第六條第二項、第八條第一項（如為間接蒐集之個人資料則為第九條第一項）規定，向台端告知下列事項，請台端詳閱：
      </div>
      <ul className="article-paragraph-00__ul article-paragraph-00__ul--null">
          ...
          <ul className="article-paragraph-00__ul">
            ...
            <li className="article-paragraph-00__li article-paragraph-00__li--parentheses-chinese">
              <div className="article-paragraph-00__text">
                對象：本(分)公司及本公司海外分支機構、中華民國產物保險商業同業公會、中華民國人壽保險商業
                同業公會、財團法人保險事業發展中心、財團法人保險安定基金、財團法人住宅地震保險基金、財
                團法人汽車交通事故特別補償基金、財團法人金融消費評議中心、財團法人金融聯合徵信中心、財
                團法人聯合信用卡中心、台灣票據交換所、財金資訊公司、關貿網路股份有限公司、中央健康保險
                局、業務委外機構、與本公司有再保業務往來之公司、依法有調查權機關或金融監理機關。
              </div>
            </li>
            <li className="article-paragraph-00__li article-paragraph-00__li--parentheses-chinese">
              <div className="article-paragraph-00__text">
        ...
        <li className="article-paragraph-00__li article-paragraph-00__li--chinese-bold">
          ...
          <ul className="article-paragraph-00__ul">
            ...
            <li className="article-paragraph-00__li article-paragraph-00__li--parentheses-chinese">
              <div className="article-paragraph-00__text">行使權利之方式：依本公司官網之「蓮花保險股份有限公司當事人依個人資料保護法行使權利
                申請書」行使之。</div>
            </li>
          </ul>
        </li>
